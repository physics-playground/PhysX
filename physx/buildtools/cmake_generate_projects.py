"""
PhysX helper script to call CMake based on current platform and any arguments
    ...
    def getPlatformCMakeParams(self):
        ...
        if self.targetPlatform == "win32":
            ...
            if self.compiler == "vc14":
                ...
                outString = outString + " -DCMAKE_VS150PATH=" + os.environ["VS150PATH"]
            elif self.compiler == "vc16":
                ...
                outString = outString + " -DCMAKE_VS160PATH=" + os.environ["VS160PATH"]
